...
public:
	...
	void		gravity(const KVector2& _Value)	{ this_KRigid2DManager.gravity(_Value); }
	KVector2&	gravity()						{ return this_KRigid2DManager.gravity(); }
...
public:
	...
	KRigid_2DManager this_KRigid2DManager;
};
